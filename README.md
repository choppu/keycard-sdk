...
For usage examples please check `example/example.ts`, `example/global-platform-example.ts`, `example/runOnSecureChannelExample.ts` which shows most of the SDK functionality. You can also check [Keycard Desktop](https://github.com/choppu/keycard-desktop) application which can be used to manage Keycard.
