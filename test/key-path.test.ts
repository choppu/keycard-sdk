...
const parentPath = "../44'/0'/0'/0/1";
const currentPath = "./44'/0'/0'/0/1";
const defPath = "44'/0'/0'/0/1"
const pathBytes = new Uint8Array([0x80, 0x00, 0x00, 0x2c, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]);
